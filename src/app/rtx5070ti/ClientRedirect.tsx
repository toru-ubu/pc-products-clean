...
function Rtx5070TiPageContent() {
  ...
  const [filterState, setFilterState] = useState({
    applied: {
      maker: [] as string[],
      cpu: [] as string[],
      gpu: ['RTX 5070 Ti (16GB)'] as string[],
      memory: [] as string[],
      storage: [] as string[],
      showDesktop: true,
      showNotebook: false,
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      logCustomEvent('page_view', {
        page_name: 'rtx5070ti',
        page_title: 'RTX 5070 Ti (16GB) | 最安値・安い順',
  ...
  const applyFilters = useCallback(() => {
    ...
    document.title = 'RTX 5070 Ti (16GB)搭載PC 最安値・安い順 | イヤバズnavi';
    ...
    <div className="nextjs-products-scope">
      <div className="min-h-screen" style={{ background: '#f5f5f5' }}>
        <div className="products-container">
          ...
          <h1 className="results-title">RTX 5070 Ti 搭載PC ｜最安値・安い順</h1>
